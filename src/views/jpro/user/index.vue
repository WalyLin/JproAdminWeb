...
<template>
  <div class="ma-content-block lg:flex justify-between p-4">
    <div class="lg:w-2/12 w-full h-full p-2 shadow">
      <ma-tree-slider :data="depts" searchPlaceholder="搜索部门" v-model="defaultKey" @click="switchDept" />
    </div>
...
const crud = reactive({
  ...
  formOption: {
    ...
    layout: [
      ...
      { formType: 'grid', cols: [{ span: 12, formList: [{ dataIndex: 'post_ids' }] },] },
      { formType: 'grid', cols: [{ span: 12, formList: [{ dataIndex: 'age' }] }, { span: 12, formList: [{ dataIndex: 'body_status' }] }] },
      { formType: 'grid', cols: [{ span: 12, formList: [{ dataIndex: 'hospital' }] }, { span: 12, formList: [{ dataIndex: 'doctor' }] }] },
...
const columns = reactive([
  ...
  { title: '年龄', dataIndex: 'age', width: 40 },
  {
    ...
    formType: 'select',
    search: true,
    dict: { name: 'body_status', translation: true},
    addDefaultValue:'1',
  },
