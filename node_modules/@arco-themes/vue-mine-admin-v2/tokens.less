...
@input-number-step-layer-border-radius: 4px;
...
@picker-color-text: var(--color-text-2);
...
@collapse-content-color-bg: var(--color-bg-4);
...
@radio-button-bg-border-radius: 4px;
...
@upload-text-item-border-radius: 4px;
