...
@collapse-content-color-bg: var(~'@{arco-cssvars-prefix}-color-bg-4');
@input-border-radius: @border-radius-medium;
@input-number-step-layer-border-radius: @border-radius-medium;
@radio-button-bg-border-radius: @border-radius-medium;
...
@tabs-card-border-radius: @border-radius-medium;
